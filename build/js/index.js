...
/***/ function(module, exports, __webpack_require__) {
	...
	var _TwitterAppJsx = __webpack_require__(157);

	var _TwitterAppJsx2 = _interopRequireDefault(_TwitterAppJsx);

	var _jsSockets = __webpack_require__(183);

	var _jsSockets2 = _interopRequireDefault(_jsSockets);

	var _HeaderJsx = __webpack_require__(184);
	...
	_react2["default"].render(_react2["default"].createElement(_TwitterAppJsx2["default"], null), document.getElementById("twitterApp"));
	_react2["default"].render(_react2["default"].createElement(_HeaderJsx2["default"], null), document.getElementById("header"));
...
/***/ function(module, exports, __webpack_require__) {
	...
	var _jsEvents = __webpack_require__(158);

	var _jsEvents2 = _interopRequireDefault(_jsEvents);

	var _InfoJsx = __webpack_require__(159);

	var _InfoJsx2 = _interopRequireDefault(_InfoJsx);

	var _LoginJsx = __webpack_require__(166);

	var _LoginJsx2 = _interopRequireDefault(_LoginJsx);

	var _FriendsWhoDontFollowJsx = __webpack_require__(169);

	var _FriendsWhoDontFollowJsx2 = _interopRequireDefault(_FriendsWhoDontFollowJsx);

	var _FollowersNotFriendsWithJsx = __webpack_require__(177);

	var _FollowersNotFriendsWithJsx2 = _interopRequireDefault(_FollowersNotFriendsWithJsx);

	var _LoadingSpinnerJsx = __webpack_require__(178);

	var _LoadingSpinnerJsx2 = _interopRequireDefault(_LoadingSpinnerJsx);

	__webpack_require__(181);

	var TwitterApp = (function (_React$Component) {
	    _inherits(TwitterApp, _React$Component);

	    function TwitterApp() {
	        _classCallCheck(this, TwitterApp);

	        _get(Object.getPrototypeOf(TwitterApp.prototype), "constructor", this).apply(this, arguments);
	        this.state = {
	            hasStarted: false,
	            error: false,
	            pending: false,
	        ...
	        _jsEvents2["default"].subscribe("state-update", this.onStateUpdate.bind(this));
	        _jsEvents2["default"].subscribe("all-data-loaded", this.onAllDataLoaded.bind(this));
	    }

	    _createClass(TwitterApp, [{
	        key: "onStateUpdate",
	        value: function onStateUpdate(data) {
	            ...
	            if (data.error) {
	                _jsEvents2["default"].publish("re-enable-login");
	            }
	        }
	    }, {
	        key: "onAllDataLoaded",
	        value: function onAllDataLoaded(data) {
	            this.setState({
	                hasStarted: true,
	                error: false,
	                pending: false,
	                ...
	                _jsEvents2["default"].publish("create-dom", data);
	            });
	        }
	    }, {
	        key: "render",
	            ...
	            if (this.state.error || !this.state.hasStarted) {
	                ...
	                display = _react2["default"].createElement(
	                    ...
	                    _react2["default"].createElement(
	                        ...
	                        _react2["default"].createElement(_LoadingSpinnerJsx2["default"], null)
	                    )
	                );
	            } else {
	                display = _react2["default"].createElement(
...
/***/ function(module, exports, __webpack_require__) {
	...
	var _jsNumberFormatter = __webpack_require__(160);

	var _jsNumberFormatter2 = _interopRequireDefault(_jsNumberFormatter);

	var _jsAnimatorMin = __webpack_require__(161);

	var _jsAnimatorMin2 = _interopRequireDefault(_jsAnimatorMin);
	...
	var Info = (function (_React$Component) {
	    ...
	    function Info() {
	        ...
	        _jsEvents2["default"].subscribe("create-dom", function (data) {
	            var percent = _this.getFollowerCoefficient(data);
	            _this.setState({
	        ...
	        _jsEvents2["default"].subscribe("info-update", function (data) {

	            if (data.desc === "user-followed") {
	                var friendsCount = _this.state.friendCount + 1;
	                var percent = _this.getFollowerCoefficient({
	                    followerCount: _this.state.followerCount,
	    ...
	    _createClass(Info, [{
	        ...
	        key: "getFollowerCoefficient",
	        value: function getFollowerCoefficient(data) {
	        ...
	        value: function show() {
	            ...
	            var infoBoxes = _react2["default"].findDOMNode(this.refs.infoHolder).querySelectorAll(".col-sm-3");
	            var percentage = _react2["default"].findDOMNode(this.refs.infoHolder).querySelector(".percent");
	            var styles = {
	                opacity: 0
	            };
	            styles[_jsAnimatorMin2["default"].getPrefix("animation-duration")] = "500ms";
	            _jsAnimatorMin2["default"].setStyles(infoBoxes, styles);

	            _jsAnimatorMin2["default"].createTransition({
	                element: infoBoxes,
	                properties: "opacity",
	                duration: "300ms",
	            ...
	            var sequence = _jsAnimatorMin2["default"].combo([_jsAnimatorMin2["default"].transition({
	                element: infoBoxes[0],
	                properties: "opacity",
	                setStyles: {
	                    before: {
	            ...
	            }), _jsAnimatorMin2["default"].animation({
	                element: infoBoxes[0],
	                addClass: {
	                    before: "slideInLeft"
	                },
	            ...
	            sequence.then(function () {
	                return _jsAnimatorMin2["default"].combo([_jsAnimatorMin2["default"].transition({
	                    element: infoBoxes[1],
	                    properties: "opacity",
	                    setStyles: {
	                        before: {
	                ...
	                return _jsAnimatorMin2["default"].transition({
	                    element: percentage,
	                    properties: "opacity",
	                    setStyles: {
	                        before: {
	        ...
	        value: function render() {
	            ...
	            return _react2["default"].createElement(
	                "div",
	                { className: "info", ref: "infoHolder" },
	                _react2["default"].createElement(
	                    "div",
	                    { className: "col-sm-3 col-xs-6 animated" },
	                    _react2["default"].createElement(
	                        "p",
	                        null,
	                        "You have ",
	                        _react2["default"].createElement(
	                            ...
	                            (0, _jsNumberFormatter2["default"])(this.state.friendCount)
	                        ),
	                        " friends."
	                    )
	                ),
	                _react2["default"].createElement(
	                    ...
	                    _react2["default"].createElement(
	                        ...
	                        _react2["default"].createElement(
	                            "span",
	                            { className: "info-value" },
	                            (0, _jsNumberFormatter2["default"])(this.state.followerCount)
	                        ),
	                        " followers."
	                    )
	                ),
	                _react2["default"].createElement(
	                    ...
	                    _react2["default"].createElement(
	                        ...
	                        _react2["default"].createElement(
	                            "span",
	                            { className: "info-value" },
	                            (0, _jsNumberFormatter2["default"])(this.state.friendsWhoDontFollow.length)
	                        ),
	                        " ",
	                        this.state.friendsWhoDontFollow.length > 1 ? "friends" : "friend",
	                ...
	                _react2["default"].createElement(
	                    ...
	                    _react2["default"].createElement(
	                        ...
	                        _react2["default"].createElement(
	                            "span",
	                            { className: "info-value" },
	                            (0, _jsNumberFormatter2["default"])(this.state.followersNotFriendsWith.length)
	                        ),
	                        " ",
	                        this.state.followersNotFriendsWith.length > 1 ? "followers" : "follower",
...
/***/ function(module, exports) {
	...
	function Num(n) {
	    return String(n).split("").reverse().map(function (char, i) {
...
/***/ function(module, exports, __webpack_require__) {
	...
	var ScreenNameForm = (function (_React$Component) {
	    _inherits(ScreenNameForm, _React$Component);

	    function ScreenNameForm() {
	        _classCallCheck(this, ScreenNameForm);

	        _get(Object.getPrototypeOf(ScreenNameForm.prototype), "constructor", this).call(this);
	        _jsEvents2["default"].subscribe("re-enable-login", this.reset.bind(this));
	        _jsEvents2["default"].subscribe("show-login", this.show.bind(this));
	    }

	    _createClass(ScreenNameForm, [{
	        key: "show",
	        value: function show() {

	            var input = _react2["default"].findDOMNode(this.refs.screenNameInput);
	            var button = _react2["default"].findDOMNode(this.refs.submit);
	            var label = _react2["default"].findDOMNode(this.refs.screenNameLabel);

	            _jsAnimatorMin2["default"].setStyles(input, {
	                opacity: 0,
	                display: "block"
	            });

	            _jsAnimatorMin2["default"].setStyles(button, {
	                opacity: 0,
	                width: "1px",
	                height: "1px",
	                display: "block"
	            ...
	            _jsAnimatorMin2["default"].setStyles(label, _jsAnimatorMin2["default"].createCSSRule(["opacity", _jsAnimatorMin2["default"].getPrefix("animation-duration")], [0, "500ms"]));
	            ...
	            sequence.then(function () {
	                return _jsAnimatorMin2["default"].animation({
	                    element: label,
	                    addClass: {
	                        before: "slideInUp"
	                    },
	        ...
	        value: function reset() {
	            ...
	            var input = _react2["default"].findDOMNode(this.refs.screenNameInput);
	            var btn = _react2["default"].findDOMNode(this.refs.submit);
	        ...
	        value: function submit(evt) {
	            ...
	            function onInvalidInput() {
	                _jsEvents2["default"].publish("state-update", {
	            ...
	            if (input.value.length) {
	                ...
	                if (input.value.length === 1 && input.value[0] !== "@" || input.value.length > 1) {
	                    _react2["default"].findDOMNode(this.refs.submit).setAttribute("disabled", "disabled");
	                    ...
	                    _jsEvents2["default"].publish("user-name-entered", input.value);
	                } else {
	                    onInvalidInput();
	                }
	            } else {
	        ...
	        value: function render() {
	            ...
	            return _react2["default"].createElement(
	                ...
	                _react2["default"].createElement(
	                    "div",
	                    { className: "form-group", ref: "form", id: "loginForm" },
	                    _react2["default"].createElement("input", { type: "text", className: "form-control animated", id: "screenName", ref: "screenNameInput", placeholder: "Your Twitter name" }),
	                    _react2["default"].createElement(
	                        "label",
	                        { ref: "screenNameLabel", className: "animated", htmlFor: "screenName" },
	                        "Your Twitter name e.g. @Your_Twitter_Handle"
	                    )
	                ),
	                _react2["default"].createElement(
	                    "button",
	                    { type: "submit", id: "submit", ref: "submit", className: "btn btn-default" },
	                    "Search!"
	                )
	            );
	        }
	...
	exports["default"] = ScreenNameForm;
	module.exports = exports["default"];
...
/***/ function(module, exports, __webpack_require__) {
	...
	var _NavButtonsRowJsx = __webpack_require__(170);

	var _NavButtonsRowJsx2 = _interopRequireDefault(_NavButtonsRowJsx);

	var _ResultsSelectJsx = __webpack_require__(171);

	var _ResultsSelectJsx2 = _interopRequireDefault(_ResultsSelectJsx);

	var _ModalJsx = __webpack_require__(172);

	var _ModalJsx2 = _interopRequireDefault(_ModalJsx);

	__webpack_require__(175);

	var FWDFTable = (function (_React$Component) {
	    _inherits(FWDFTable, _React$Component);

	    function FWDFTable() {
	        var _this = this;

	        _classCallCheck(this, FWDFTable);

	        _get(Object.getPrototypeOf(FWDFTable.prototype), "constructor", this).call(this);
	        this.state = {
	            friendsWhoDontFollow: [],
	            usersToDisplay: [],
	            page: 0,
	        ...
	        _jsEvents2["default"].subscribe("create-dom", function (data) {
	            ...
	            var usersToDisplay = _this.getUsersToDisplay(data.friendsWhoDontFollow);
	            var maxPage = Math.floor(data.friendsWhoDontFollow.length / _this.state.results);
	            if (data.friendsWhoDontFollow.length % _this.state.results === 0) {
	                maxPage--;
	            }
	        ...
	        _jsEvents2["default"].subscribe("user-unfollowed", function () {
	            _jsEvents2["default"].publish("info-update", { desc: "user-unfollowed", data: _this.state.friendsWhoDontFollow });
	        });
	    }

	    _createClass(FWDFTable, [{
	        key: "unfollowFriend",
	        value: function unfollowFriend(evt) {

	            var id = (evt.target || evt.srcElement).getAttribute("data-id");
	            var user = this.state.friendsWhoDontFollow.filter(function (user) {
	                return user.id_str === id;
	            })[0].name;

	            _jsEvents2["default"].publish("show-unfollow-modal", { id: id, user: user });
	        }
	    }, {
	        key: "modalConfirm",
	        value: function modalConfirm(allow, id) {

	            if (allow) {
	                var fwdf = this.state.friendsWhoDontFollow.filter(function (user) {
	                    return user.id_str !== id;
	                });
	                var usersToDisplay = this.getUsersToDisplay(fwdf);
	                var maxPage = Math.floor(fwdf.length / this.state.results);
	                ...
	                this.setState({
	                    ...
	                    _jsEvents2["default"].publish("unfollow-user", id);
	                });
	            }
	        }
	    }, {
	        ...
	        value: function setData(page) {
	            ...
	            this.setState({
	                ...
	                var usersToDisplay = _this2.getUsersToDisplay(_this2.state.friendsWhoDontFollow);
	                _this2.setState({
	                    usersToDisplay: usersToDisplay
	                });
	            });
	        ...
	        key: "getUsersToDisplay",
	        value: function getUsersToDisplay(followersNotFriendsWith) {
	            var max = (this.state.page + 1) * this.state.results;
	            var min = this.state.page * this.state.results;
	        ...
	        key: "setPageResults",
	        value: function setPageResults(evt) {
	            var _this3 = this;

	            var select = document.querySelector("#friends-select");
	            var options = select.options;
	            var resultsToDisplay = Number(options[select.selectedIndex].getAttribute("value"));

	            var maxPage = Math.floor(this.state.friendsWhoDontFollow.length / resultsToDisplay);
	            var page = this.state.page;
	            ...
	            this.setState({
	                ...
	                var usersToDisplay = _this3.getUsersToDisplay(_this3.state.friendsWhoDontFollow);
	                _this3.setState({
	                    usersToDisplay: usersToDisplay
	                });
	            });
	        ...
	        value: function render() {
	            ...
	            if (this.state.usersToDisplay.length) {
	                var markup = this.state.usersToDisplay.map(function (friend, i) {

	                    var bkimg = friend.profile_background_image_url_https ? "url(" + friend.profile_background_image_url_https + ") top center / cover no-repeat" : "#666";
	                    var background = { background: bkimg };
	                    var bannerImg = friend.profile_banner_url ? "url(" + friend.profile_banner_url + ") top center / cover no-repeat" : "#666";
	                    var banner = { background: bannerImg };

	                    return _react2["default"].createElement(
	                        "tr",
	                        { key: i, style: background, className: "user-row" },
	                        _react2["default"].createElement(
	                            "td",
	                            null,
	                            _react2["default"].createElement(
	                                "div",
	                                { className: "profile-banner", style: banner },
	                                _react2["default"].createElement(
	                                    "span",
	                                    { className: "friend-num" },
	                                    (0, _jsNumberFormatter2["default"])(i + 1 + _this4.state.page * _this4.state.results)
	                                ),
	                                _react2["default"].createElement(
	                                    "a",
	                                    { target: "_blank", className: "friend-img-link", href: url + friend.screen_name },
	                                    _react2["default"].createElement("img", { className: "friend-img", src: friend.profile_image_url })
	                                ),
	                                _react2["default"].createElement(
	                                    "span",
	                            ...
	                            _react2["default"].createElement(
	                                ...
	                                _react2["default"].createElement(
	                                    ...
	                                    _react2["default"].createElement(
	                                        "a",
	                                        { target: "_blank", className: "friend-handle-link", href: url + friend.screen_name },
	                                        _react2["default"].createElement(
	                                            "p",
	                                    ...
	                                    _react2["default"].createElement("hr", { className: "hr-wide" })
	                                ),
	                                _react2["default"].createElement(
	                                    "div",
	                                    { className: "count-holder row" },
	                                    _react2["default"].createElement(
	                                        "div",
	                                        { className: "col-xs-6 col-border-right" },
	                                        _react2["default"].createElement(
	                                            "a",
	                                            { target: "_blank", href: url + friend.screen_name + "/following" },
	                                            _react2["default"].createElement(
	                                                "p",
	                                            ...
	                                            _react2["default"].createElement(
	                                                "p",
	                                                { className: "count" },
	                                                (0, _jsNumberFormatter2["default"])(friend.friends_count)
	                                            )
	                                        )
	                                    ),
	                                    _react2["default"].createElement(
	                                        ...
	                                        _react2["default"].createElement(
	                                            "a",
	                                            { target: "_blank", href: url + friend.screen_name + "/followers" },
	                                            _react2["default"].createElement(
	                                                "p",
	                                                { className: "count-title" },
	                                                "Followers"
	                                            ...
	                                            _react2["default"].createElement(
	                                                "p",
	                                                { className: "count" },
	                                                (0, _jsNumberFormatter2["default"])(friend.followers_count)
	                                            )
	                                        )
	                                    )
	                                ),
	                                _react2["default"].createElement(
	                                    "div",
	                                    { className: "col-sm-12 btn-holder" },
	                                    _react2["default"].createElement(
	                                        "button",
	                                        { className: "btn user-btn", "data-id": friend.id_str, onClick: _this4.unfollowFriend.bind(_this4) },
	                                        "Unfollow"
	                                    )
	                                )
	                            )
...
/***/ function(module, exports, __webpack_require__) {
	...
	var NavButtonsRow = (function (_React$Component) {
	    _inherits(NavButtonsRow, _React$Component);

	    function NavButtonsRow() {
	        _classCallCheck(this, NavButtonsRow);

	        _get(Object.getPrototypeOf(NavButtonsRow.prototype), "constructor", this).apply(this, arguments);
	    }

	    _createClass(NavButtonsRow, [{
	        key: "render",
	        value: function render() {
	            return _react2["default"].createElement(
	                "tr",
	                ...
	                _react2["default"].createElement(
	                    ...
	                    _react2["default"].createElement(
	                        "button",
	                        { className: "btn btn-primary prev-page", onClick: this.props.prev },
	                        "Prev"
	                    ),
	                    _react2["default"].createElement(
	                        "span",
	                    ...
	                    _react2["default"].createElement(
	                        "button",
	                        { className: "btn btn-primary next-page", onClick: this.props.next },
	                        "Next"
	                    )
	                )
	            );
	    ...
	    return NavButtonsRow;
	})(_react2["default"].Component);

	exports["default"] = NavButtonsRow;
	module.exports = exports["default"];
...
/***/ function(module, exports, __webpack_require__) {
	...
	var ResultsSelect = (function (_React$Component) {
	    _inherits(ResultsSelect, _React$Component);

	    function ResultsSelect() {
	        _classCallCheck(this, ResultsSelect);

	        _get(Object.getPrototypeOf(ResultsSelect.prototype), "constructor", this).apply(this, arguments);
	    }

	    _createClass(ResultsSelect, [{
	        key: "render",
	        value: function render() {
	            return _react2["default"].createElement(
	                "div",
	                ...
	                _react2["default"].createElement(
	                    "select",
	                    { className: "form-control resultsSize", id: this.props.id, onChange: this.props.setPageResults },
	                    _react2["default"].createElement(
	                        "option",
	                        { value: "3" },
	                        "3"
	                ...
	                _react2["default"].createElement(
	                    "em",
	                    { className: "resultsDisplayed" },
	                    "Showing results ",
	                    (0, _jsNumberFormatter2["default"])(this.props.min),
	                    " to ",
	                    (0, _jsNumberFormatter2["default"])(this.props.max),
	                    " of ",
	                    (0, _jsNumberFormatter2["default"])(this.props.count),
	                    "."
	                )
	            );
	        }
...
/***/ function(module, exports, __webpack_require__) {
	...
	var Modal = (function (_React$Component) {
	    ...
	    function Modal() {
	        ...
	        _jsEvents2["default"].subscribe(this.props.onShow, this.show.bind(this));
	    }
	    ...
	    _createClass(Modal, [{
	        ...
	        value: function show(data) {
	            ...
	            if (this.state.allowClick) {
	                ...
	                var msg = this.state.msg.replace("userX", data.user);
	                ...
	                _jsAnimatorMin2["default"].setStyles(overlay, {
	        ...
	        value: function hide() {
	            ...
	            if (this.state.allowClick) {
	                (function () {
	                    ...
	                    var msg = _this.state.msg.replace(_this.state.username, "userX");

	                    var sequence = _jsAnimatorMin2["default"].combo([_jsAnimatorMin2["default"].animation({
	                        element: modal,
	                        setStyles: {
	                            after: {
	                                top: "-350px"
	                    ...
	                    }), _jsAnimatorMin2["default"].transition({
	                        element: overlay,
	                        properties: "opacity",
	                        setStyles: {
	                            before: {
	        ...
	        value: function render() {
	            return _react2["default"].createElement(
	                "div",
	                { className: "action-modal animated", ref: "modal" },
	                _react2["default"].createElement(
	                    "div",
	                    { className: "row" },
	                    _react2["default"].createElement(
	                    ...
	                    _react2["default"].createElement(
	                        ...
	                        _react2["default"].createElement(
	                            "button",
	                            { className: "btn modal-btn-confirm", onClick: this.confirm.bind(this, true) },
	                            "Confirm"
	                        )
	                    ),
	                    _react2["default"].createElement(
	                        ...
	                        _react2["default"].createElement(
	                            "button",
	                            { className: "btn modal-btn-cancel", onClick: this.confirm.bind(this, false) },
	                            "Cancel"
	                        )
	                    )
	                )
...
/***/ function(module, exports, __webpack_require__) {
	...
	var FNFWTable = (function (_React$Component) {
	    _inherits(FNFWTable, _React$Component);

	    function FNFWTable() {
	        var _this = this;

	        _classCallCheck(this, FNFWTable);

	        _get(Object.getPrototypeOf(FNFWTable.prototype), "constructor", this).apply(this, arguments);
	        this.state = {
	            followersNotFriendsWith: [],
	            usersToDisplay: [],
	            page: 0,
	        ...
	        _jsEvents2["default"].subscribe("create-dom", function (data) {
	            ...
	            var usersToDisplay = _this.getUsersToDisplay(data.followersNotFriendsWith);
	            var maxPage = Math.floor(data.followersNotFriendsWith.length / _this.state.results);
	            if (data.followersNotFriendsWith.length % _this.state.results === 0) {
	                maxPage--;
	            }
	        ...
	        _jsEvents2["default"].subscribe("user-followed", function () {
	            _jsEvents2["default"].publish("info-update", { desc: "user-followed", data: _this.state.followersNotFriendsWith });
	        });
	    }

	    _createClass(FNFWTable, [{
	        key: "setData",
	        value: function setData(page) {
	            var _this2 = this;
	            ...
	            this.setState({
	                ...
	                var usersToDisplay = _this2.getUsersToDisplay(_this2.state.followersNotFriendsWith);
	                _this2.setState({
	                    usersToDisplay: usersToDisplay
	                });
	            });
	        ...
	        key: "followFollower",
	        value: function followFollower(evt) {

	            var id = (evt.target || evt.srcElement).getAttribute("data-id");
	            var user = this.state.followersNotFriendsWith.filter(function (user) {
	                return user.id_str === id;
	            })[0].name;

	            _jsEvents2["default"].publish("show-follow-modal", { id: id, user: user });
	        }
	    }, {
	        key: "modalConfirm",
	        value: function modalConfirm(allow, id) {
	            ...
	            if (allow) {
	                ...
	                var fnfw = this.state.followersNotFriendsWith.filter(function (user) {
	                    return user.id_str !== id;
	                });
	                var usersToDisplay = this.getUsersToDisplay(fnfw);
	                var maxPage = Math.floor(fnfw.length / this.state.results);
	                var page = this.state.page;
	                ...
	                this.setState({
	                    ...
	                    _jsEvents2["default"].publish("follow-user", id);
	                });
	            }
	        }
	    }, {
	        key: "setPageResults",
	        value: function setPageResults() {
	            var _this3 = this;

	            var select = document.querySelector("#followers-select");
	            var options = select.options;
	            var resultsToDisplay = Number(options[select.selectedIndex].getAttribute("value"));

	            var maxPage = Math.floor(this.state.followersNotFriendsWith.length / resultsToDisplay);
	            var page = this.state.page;
	            ...
	            this.setState({
	                ...
	                var usersToDisplay = _this3.getUsersToDisplay(_this3.state.followersNotFriendsWith);
	                _this3.setState({
	                    usersToDisplay: usersToDisplay
	                });
	            });
	        ...
	        value: function render() {
	            ...
	            if (this.state.usersToDisplay.length) {
	                ...
	                var markup = this.state.usersToDisplay.map(function (follower, i) {

	                    var bkimg = follower.profile_background_image_url_https ? "url(" + follower.profile_background_image_url_https + ") top center / cover no-repeat" : "#666";
	                    var background = { background: bkimg };
	                    var bimg = follower.profile_banner_url ? "url(" + follower.profile_banner_url + ") top center / cover no-repeat" : "#666";
	                    var banner = { background: bimg };
	                    ...
	                    return _react2["default"].createElement(
	                        ...
	                        _react2["default"].createElement(
	                            ...
	                            _react2["default"].createElement(
	                                ...
	                                _react2["default"].createElement(
	                                    "a",
	                                    { className: "friend-img-link", target: "_blank", href: url + follower.screen_name },
	                                    _react2["default"].createElement("img", { className: "friend-img", src: follower.profile_image_url })
	                                ),
	                                _react2["default"].createElement(
	                                    "span",
	                                    { className: "friend-name" },
	                            ...
	                            _react2["default"].createElement(
	                                ...
	                                _react2["default"].createElement(
	                                    ...
	                                    _react2["default"].createElement(
	                                        "a",
	                                        { target: "_blank", className: "friend-handle-link", href: url + follower.screen_name },
	                                        _react2["default"].createElement(
	                                            "p",
	                                            { className: "friend-handle" },
	                                            "@",
	                                    ...
	                                    _react2["default"].createElement(
	                                        "p",
	                                        { className: "friend-description" },
	                                        follower.description || "No description"
	                                    ),
	                                    _react2["default"].createElement("hr", { className: "hr-wide" })
	                                ),
	                                _react2["default"].createElement(
	                                    ...
	                                    _react2["default"].createElement(
	                                        ...
	                                        _react2["default"].createElement(
	                                            "a",
	                                            { target: "_blank", href: url + follower.screen_name + "/following" },
	                                            _react2["default"].createElement(
	                                                "p",
	                                                { className: "count-title" },
	                                                "Friends"
	                                            ...
	                                            _react2["default"].createElement(
	                                                "p",
	                                                { className: "count" },
	                                                (0, _jsNumberFormatter2["default"])(follower.friends_count)
	                                            )
	                                        )
	                                    ),
	                                    _react2["default"].createElement(
	                                        ...
	                                        _react2["default"].createElement(
	                                            "a",
	                                            { target: "_blank", href: url + follower.screen_name + "/followers" },
	                                            _react2["default"].createElement(
	                                                "p",
	                                                { className: "count-title" },
	                                                "Followers"
	                                            ...
	                                            _react2["default"].createElement(
	                                                "p",
	                                                { className: "count" },
	                                                (0, _jsNumberFormatter2["default"])(follower.followers_count)
	                                            )
	                                        )
	                                    )
	                                ),
	                                _react2["default"].createElement(
	                                    ...
	                                    _react2["default"].createElement(
	                                        "button",
	                                        { className: "btn user-btn", "data-id": follower.id_str, onClick: _this4.followFollower.bind(_this4) },
	                                        "Follow"
	                                    )
	                                )
	                            )
...
/***/ function(module, exports, __webpack_require__) {
	...
	var LoadingSpinner = (function (_React$Component) {
	    ...
	    function LoadingSpinner() {
	        ...
	        _get(Object.getPrototypeOf(LoadingSpinner.prototype), "constructor", this).apply(this, arguments);
	    }
...
/***/ function(module, exports, __webpack_require__) {
	...
	var Sockets = (function () {
	    function Sockets() {
	        ...
	        _jsEvents2["default"].subscribe("user-name-entered", this.onUserNameEntered.bind(this));
	        _jsEvents2["default"].subscribe("follow-user", this.onFollowUser.bind(this));
	        _jsEvents2["default"].subscribe("unfollow-user", this.onUnfollowUser.bind(this));
	    }

	    _createClass(Sockets, [{
	        key: "onUserId",
	        value: function onUserId(data) {
	            console.log("socket id", data);
	        }
	    }, {
	        key: "onServerUpdate",
	        value: function onServerUpdate(data) {
	            _jsEvents2["default"].publish("state-update", data);
	        }
	    }, {
	        key: "onUserNameEntered",
	        value: function onUserNameEntered(data) {
	            this.socket.emit("user-name-entered", data);
	        }
	    }, {
	        key: "onFollowUser",
	        value: function onFollowUser(data) {
	            this.socket.emit("follow-user", data);
	        }
	    }, {
	        key: "onUnfollowUser",
	        value: function onUnfollowUser(data) {
	            this.socket.emit("unfollow-user", data);
	        }
	    }, {
	        key: "onUserFollow",
	        value: function onUserFollow() {
	            _jsEvents2["default"].publish("user-followed");
	        }
	    }, {
	        key: "onUserUnfollow",
	        value: function onUserUnfollow() {
	            _jsEvents2["default"].publish("user-unfollowed");
	        }
	    }, {
	        key: "onDataLoaded",
	        value: function onDataLoaded(data) {
	            _jsEvents2["default"].publish("all-data-loaded", data);
	        }
	    }]);
	...
	var Header = (function (_React$Component) {
	    ...
	    _createClass(Header, [{
	        ...
	        value: function componentDidMount() {
	            ...
	            var text = Array.from(_react2["default"].findDOMNode(this.refs.title).querySelectorAll(".page-title"));
	            var subtitle = _react2["default"].findDOMNode(this.refs.subtitle);

	            _jsAnimatorMin2["default"].setStyles(header, {
	                opacity: 0,
	                "background-color": "#F9F9F9"
	            });

	            _jsAnimatorMin2["default"].setStyles(subtitle, {
	                opacity: 0
	            });

	            _jsAnimatorMin2["default"].addClass(text, "animated");
	            ...
	            var sequence = _jsAnimatorMin2["default"].transition({
	                element: header,
	                properties: ["opacity", "background-color"],
	                setStyles: {
	                    before: {
	            ...
	            sequence.then(function () {
	                _jsEvents2["default"].publish("show-login");
	                return _jsAnimatorMin2["default"].combo([_jsAnimatorMin2["default"].animation({
	                    element: text[0],
	                    setStyles: {
	                        before: {
	                            opacity: 1
	        ...
	        value: function render() {
	            return _react2["default"].createElement(
	                ...
	                _react2["default"].createElement(
	                    "p",
	                    { ref: "subtitle" },
	                    "A tool to find which of your Twitter friends don't follow you and which of your followers you're not friends with."
	                )
	            );
	        }
	    }]);
